...
text(Brms1_1-200,rms1_1*1.05,paste("RMSB[21]=",round(rms1_1,0)),col="green",cex=0.8)
...
text(Brms2_1-50,rms2_1*1.05,paste("RMSB[21]=",round(rms2_1,0)),col="red",cex=0.8)
...
text(Brms3_1-220,rms3_1*1,paste("RMSB[21]=",round(rms3_1,0)),col="black",cex=0.8)
